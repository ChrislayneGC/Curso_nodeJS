...
module.exports = class TaskController {
  ...
  static toggleTaskStatus(req, res) {
    ...
    const task = { //ver o status da task
      done: req.body.done === '0' ? true : false, //Oque vem do body, se for = 0 vai trocar por true, se não 1 = false
    }

    console.log(task) 

    Task.update(task, { where: { id: id } })
      .then(res.redirect('/tasks')) //Redirecionando 
      .catch((err) => console.log())
  }
}