...
const pool = require('./db/conn') //Variavel de execucao agora é POOL
...
app.post('/books/insertbook', function (req, res) {
  ...
  const query = `INSERT INTO books (??, ??) VALUES (?, ?)` //Colunas 2 ??, Dados 1 ?.
  const data = ['title', 'pageqty', title, pageqty] //Array para dizer oque vai ser substituido.
